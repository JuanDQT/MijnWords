    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivlanguage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Spinner spLanguages = (Spinner) vLanguages.findViewById(R.id.spLanguages);
//                SpinnerLanguageAdapter adapter = new SpinnerLanguageAdapter(HomeActivity.this, R.layout.sp_languages);
