...
public class FragmentModoCondicional extends Fragment implements View.OnClickListener {
    ...
    @SuppressLint("ValidFragment")
    public FragmentModoCondicional(ModoVerbo modoVerbo) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = LayoutInflater.from(getActivity()).inflate(R.layout.fragent_modo_condicional, null);

        RelativeLayout rlModo = (RelativeLayout) view.findViewById(R.id.RlModoCondicional);

        constraintLayout = (ConstraintLayout) view.findViewById(R.id.c1);
        ...
        for (int i = 0, index = 0; i < rlModo.getChildCount(); i++) {
            ...
            if (rlModo.getChildAt(i) instanceof ConstraintLayout) {
                ...
                for (int j = 0; j < modoVerbo.getCondicional().size(); j++) {
